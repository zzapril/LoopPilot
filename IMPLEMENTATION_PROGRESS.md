...
- [x] `0.4.1` hardening release: verifier-only command gates, shared file-safety helpers, runtime/test separation, reduced package contents, pinned CI actions, bounded CI jobs, and npm OIDC publishing preparation.
