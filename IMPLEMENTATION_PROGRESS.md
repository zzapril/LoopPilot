...
- [x] Fixture coverage report for decision distribution, high-risk keyword coverage, and minimum taxonomy coverage.
...
- [x] Install/doctor integration validation in a temporary project, including explicit `doctor --json --output`.
