...
Use this skill when the user asks whether a task can loop, asks Claude Code to continue until a gate passes, or asks for a safe agent loop.
...
9. Execute in the current Claude Code session only within the contract.
