...
Use this skill when the user asks whether a task can loop, which agent execution mode to use, asks to keep working until a gate passes, asks for a safe agent loop, or asks LoopPilot to evaluate a GitHub issue URL.
