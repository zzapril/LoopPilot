...
5. `release-checklist.md`, `release-notes-0.1.0.md`, `release-notes-0.2.0.md`, `release-notes-0.2.1.md`, `release-notes-0.2.2.md`, and `release-notes-0.2.3.md` - published release records.
...
The v2 orchestration documents now authorize only the narrow agent-native single issue intake implemented for `0.2.0`. The `0.2.1` through `0.2.3` line simplifies the user-facing install/help path and tightens dependency mutation guardrails without adding a runner, provider registry, GitHub queue, scheduler, hooks integration, automatic resume, or `looppilot run`.
